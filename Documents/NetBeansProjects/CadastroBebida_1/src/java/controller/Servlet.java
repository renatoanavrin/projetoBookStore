...
public class Servlet extends HttpServlet {
    ...
    public Servlet() {
        ...
        commands.put("EDITAR",new ConsultarCommand());
         ...
         */
        vhs.put("/lojaLivros/consultalivro", new LivroViewHelper());
        vhs.put("/lojaLivros/cadastrolivro", new LivroViewHelper());
    }
    ...
    protected void doProcessRequest(HttpServletRequest request,
        ...
        ICommand command = commands.get(operacao.toUpperCase());
